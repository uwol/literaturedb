...
if(is_array($person) && isset($person['id']) && is_numeric($person['id'])){
	...
	if(isOwnPerson($person) && $mode == 'edit'){ //Edit person
		...
		if(isOwnPerson($person))
			echo ' <a href="index.php?pid=literaturedb_person&amp;mode=edit&amp;personAddress=' .LibString::protectXSS($person['person_address']). '"><img src="img/icons/page_white_edit.png" alt="edit"/></a>';
		echo ' </p>';

...
elseif(!isset($_GET['tag']) || $_GET['tag'] == ''){
	...
	*/
	...
	echo '<p><i class="fa fa-plus-circle" aria-hidden="true"></i> <a href="index.php?pid=literaturedb_document">Add document</a></p>';
...
//documents without a tag
elseif($_GET['tag'] == '!notag'){
...
if((!isset($_GET['tag']) ||$_GET['tag'] == '') && $searchString == ''){
	...
	if(count($shares) > 0){
		...
		echo '<i class="fa fa-lightbulb-o" aria-hidden="true" title="&quot;all users&quot; can be inperformant"></i>';
		echo '</fieldset></form>';
	}
}

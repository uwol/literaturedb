...
* Close user account
*/
echo '<p><a href="index.php?pid=literaturedb_settings&amp;action=closeAccount" onclick="return confirm(\'Are you sure you want to delete your user account?\')"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete my user account</a></p>';
